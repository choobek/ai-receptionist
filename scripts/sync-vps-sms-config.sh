...
AI_RECEPTIONIST_ASSISTANT_TOOL_TIMEOUT_MS="$(get_context_value "$ENVIRONMENT" "AI_RECEPTIONIST_ASSISTANT_TOOL_TIMEOUT_MS" "AI_RECEPTIONIST_ASSISTANT_TOOL_TIMEOUT_MS")"
AI_RECEPTIONIST_BOOKING_SMS_MODE="$(get_context_value "$ENVIRONMENT" "AI_RECEPTIONIST_BOOKING_SMS_MODE" "AI_RECEPTIONIST_BOOKING_SMS_MODE")"
